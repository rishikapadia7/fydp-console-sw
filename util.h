...
/* This file is a console SW replacement for the util.h created by Ghanan on the board.
	Do not copy this file over to the board and use the existing util.h on the board.
*/
